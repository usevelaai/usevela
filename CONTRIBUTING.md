...
Thank you for your interest in contributing to vela! This document provides guidelines and information for contributing to our open-source project.
...
- **Structure**: Follow the modular structure in `server/vela/`
...
By contributing to vela, you agree that your contributions will be licensed under the same license as the project.
